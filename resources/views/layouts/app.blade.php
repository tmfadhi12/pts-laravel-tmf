...
<head>
  ...
  <link href="{{url('css/black-dashboard.css?v=1.0.0')}}" rel="stylesheet" />
...
<body class=" ">
  <div class="wrapper ">
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent   ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Karyawan Page</a>
          </div>
    ...
    <script src="{{url('js/black-dashboard.min.js?v=1.0.0')}}" type="text/javascript"></script>
